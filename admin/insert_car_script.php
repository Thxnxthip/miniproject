...
$sql = "INSERT INTO tb_cars (brand, model, year, color, price, license_plate, type ,time_dt, picture)
        VALUES (:brand, :model, :year, :color, :price, :license_plate, :type, :time_dt, :picture)";
